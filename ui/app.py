...
def create_app():
    ...
    with gr.Blocks(css=css, theme=gr.themes.Base()) as app:
        ...
        歡迎來到 ReviveAI！🛒  
        這裡是專為二手商品打造的 AI 文案小幫手，讓你的商品描述更吸睛、交易更容易，還能一起守護地球！🌏

        ### 🚀 如何開始？
        1. **選擇服務**：點選上方「拍賣網站」、「社群賣文」或「社群徵文」分頁，依需求切換。
        2. **上傳圖片**：加張商品美照（徵文可選填），吸引更多目光！
        3. **填寫資訊**：輸入商品名稱、品牌、狀態、價格等，越詳細越好。
        4. **挑選文案風格**：想要專業、活潑還是故事感？隨你選！
        5. **點擊「生成文案」**：AI 立刻幫你產出專屬文案。
        6. **複製文案 & 查看環保數據**：右側可一鍵複製文案，還能看到碳足跡數值與互動圖表，讓你的永續行動看得見！

        ### 🌟 系統特色
        - **智能圖片分析**：自動解析商品照片，幫你抓出亮點。
        - **專屬表單設計**：針對二手商品需求，資訊填寫超直覺。
        - **多平台文案優化**：不論拍賣還是社群，文案都能量身打造。
        - **碳足跡計算 & 視覺化**：每筆交易都能看到減碳成效，數據用圖表呈現，超有感！
        - **即時生成**：文案與分析結果即時呈現，省時又方便。

        ### ♻️ 永續理念
        選擇二手，就是為地球盡一份心力！  
        每一次買賣，都能減少新製造帶來的碳排放與資源浪費。  
        透過 ReviveAI，讓你的永續行動被看見，也讓好物找到新主人！

        感謝你的加入，讓我們一起用科技推動更美好的未來！💚
